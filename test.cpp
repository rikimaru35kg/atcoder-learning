...
int main () {
    ...
    cin.tie(nullptr);
    LONG(r1, c1, r2, c2); --r1, --c1;
    Combination comb(2e6+20, 1e9+7);
    mint ans = 0;
    ans += comb(r2+c2+2, r2+1) - 1;
    ans -= comb(r1+c2+2, r1+1) - 1;
    de2(r1,c2)de(comb(r1+c2+2, r1+1) - 1)
    ans -= comb(r2+c1+2, r2+1) - 1;
    ans += comb(r1+c1+2, r1+1) - 1;
    Out(ans);
