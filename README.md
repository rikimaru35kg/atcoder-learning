...
### 例題
- !復習価値低 丸太切り [E - Logs](https://atcoder.jp/contests/abc174/tasks/abc174_e)
- !復習価値中 二分探索良問 [D - 射撃王](https://atcoder.jp/contests/abc023/tasks/abc023_d)
- !復習価値中 混乱しがちな実装だが良問 [E - Handshake](https://atcoder.jp/contests/abc149/tasks/abc149_e)
- !復習価値高 基本だが判定が悩ましい [001 - Yokan Party（★4）](https://atcoder.jp/contests/typical90/tasks/typical90_a)
...
## 二分探索による中央値探索
### 例題
- !復習価値中 中央値の最小値 良問 [D - Pond](https://atcoder.jp/contests/abc203/tasks/abc203_d)
...
- !復習価値高 平均＆中央値最大化（良問） [E - Average and Median](https://atcoder.jp/contests/abc236/tasks/abc236_e)
...
- !復習価値中 最大値X最小値Yとなる区間の総数 [E - Max Min](https://atcoder.jp/contests/abc247/tasks/abc247_e)
...
- !復習価値中 1からの距離総和が最小な全域木 [E - Road Reduction](https://atcoder.jp/contests/abc252/tasks/abc252_e)
...
- !復習価値中 グリッド上AB差の最小値 [E - Balanced Path](https://atcoder.jp/contests/abc147/tasks/abc147_e)
...
### 例題
- !復習価値高 [H - 履修登録](https://atcoder.jp/contests/past17-open/tasks/past17_h)
...
### 例題
- !復習価値中 グループ分け [U - Grouping](https://atcoder.jp/contests/dp/tasks/dp_u)
...
- !復習価値高 [L - 嘘つきな生徒たち](https://atcoder.jp/contests/past202112-open/tasks/past202112_l)
...
- !復習価値高 隣り合う頂点を選択して全被覆 [E - Takahashi and Animals](https://atcoder.jp/contests/abc251/tasks/abc251_e)
...
### 例題
<!-- - !下に同じ問題あり。今のところ全方位の例題なし。要復習 距離総和を全頂点について求める（想定解は全方位木DPではない） [F - Distance Sums 2](https://atcoder.jp/contests/abc220/tasks/abc220_f) -->
...
- !要復習 着く駅の数最大化（実装メイン） [B - 準急電車 (Semiexpress)](https://atcoder.jp/contests/joi2017ho/tasks/joi2017ho_b)
...
### 例題
- !復習価値高 種類数総和 [E - I Hate Sigma Problems](https://atcoder.jp/contests/abc371/tasks/abc371_e)
...
- !要復習 [K - 連結チェック](https://atcoder.jp/contests/past202209-open/tasks/past202209_k)
