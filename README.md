...
- !復習価値低 [J - 3 人組](https://atcoder.jp/contests/past19-open/tasks/past19_j)
- !復習価値低 [joi_flag - 日本情報オリンピック旗](https://atcoder.jp/contests/joisc2012/tasks/joisc2012_joi_flag)
...
- 基本 O(N)でも解きたい [D - Many Segments 2](https://atcoder.jp/contests/abc377/tasks/abc377_d)
...
- !復習価値低 [F - Sums of Sliding Window Maximum](https://atcoder.jp/contests/abc407/tasks/abc407_f)
...
- 基本 [E- Bishop 2](https://atcoder.jp/contests/abc246/tasks/abc246_e)
...
- 基本 温度差屋敷脱出 [F - ヘビの JOI 君 (Snake JOI)](https://atcoder.jp/contests/joi2017yo/tasks/joi2017yo_f)
...
### 例題
- 基本 [E - Coins Respawn](https://atcoder.jp/contests/abc137/tasks/abc137_e)
...
### 例題
- 基本 最短閉路問題 [C - Blue Bird](https://atcoder.jp/contests/abc022/tasks/abc022_c)
- 基本 最短路かつ最大価値 [E - Souvenir](https://atcoder.jp/contests/abc286/tasks/abc286_e)
- 基本 最短経路＋その場合の数（巡回セールスマン） [G - Revenge of Traveling Salesman Problem](https://atcoder.jp/contests/s8pc-1/tasks/s8pc_1_g)
- 基本 [F - Pond Skater](https://atcoder.jp/contests/abc170/tasks/abc170_f)
...
- 誤解のないように追記するが一般に最長経路問題が解ける条件は、正辺がなければダイクストラ、正閉路がなければベルマンフォードやワーシャルフロイドで解ける（つまり**通常の最長経路問題はWFやBFで解ける**）
### 例題
...
- 基本（サイクル検出そのものではないが実装面で勉強になる載せたがNote非掲載） [D - Moving Piece](https://atcoder.jp/contests/abc175/tasks/abc175_d)
...
- 基本 じゃがいも詰め [E - Packing Potatoes](https://atcoder.jp/contests/abc258/tasks/abc258_e)
...
- 基本 最小始点数 [advertisement - 宣伝 (Advertisement)](https://atcoder.jp/contests/joisc2009/tasks/joisc2009_advertisement)
...
### 例題
- 基本 グラフ上K日旅程の場合の数 [E - Safety Journey](https://atcoder.jp/contests/abc212/tasks/abc212_e)
...
- 基本 置き換えor和の操作を最大K回無視して最大化 [F - Ignore Operations](https://atcoder.jp/contests/abc249/tasks/abc249_f)
...
- 基本 [No.2924 <===Super Spaceship String===>](https://yukicoder.me/problems/no/2924)
- 基本 文字列をつなげて括弧列を作れるか [F - Bracket Sequencing](https://atcoder.jp/contests/abc167/tasks/abc167_f)
- 基本 最高気温の最小化（括弧列の問題ではないのでNote非掲載） [C - 魔法使い高橋君](https://atcoder.jp/contests/arc053/tasks/arc053_c)
...
- 基本 [M - ランキング](https://atcoder.jp/contests/past202203-open/tasks/past202203_m)
...
### 例題
- !復習価値低 [G - Odd Position Sum Query](https://atcoder.jp/contests/abc403/tasks/abc403_g)
...
- 基本 工夫するとdpの状態オーダーを減らせる [F - Select Half](https://atcoder.jp/contests/abc162/tasks/abc162_f)
...
- 基本 分散最小袋分け [E - Lucky bag](https://atcoder.jp/contests/abc332/tasks/abc332_e)
...
- 基本 [No.2889 Rusk](https://yukicoder.me/problems/no/2889)
...
### 例題
- 基本 [I - 部分列ペア](https://atcoder.jp/contests/past17-open/tasks/past17_i)
...
- 基本 部分列DP [K - 部分列](https://atcoder.jp/contests/past202206-open/tasks/past202206_k)
...
### 例題
- 基本 [K - 正しいチェックディジット](https://atcoder.jp/contests/past17-open/tasks/past17_k)
...
- 基本 [D - 飴 2 (Candies 2)](https://atcoder.jp/contests/joi2022yo2/tasks/joi2022_yo2_d)
- 基本 [M - 棒の出荷](https://atcoder.jp/contests/past202012-open/tasks/past202012_m)
...
- 基本 [B - お菓子の分割](https://atcoder.jp/contests/joi2010ho/tasks/joi2010ho_b)
...
- !復習価値中 [F - Critical Misread](https://atcoder.jp/contests/abc458/tasks/abc458_f)
...
### 例題
!!! where i am now for rank S (last submission 2026/6/25)
...
- !要復習 [E - LCM Sequence](https://atcoder.jp/contests/abc412/tasks/abc412_e)
...
### 例題
- 基本 埋めつくし計算式を理解していれば解ける良問 [D - Marking](https://atcoder.jp/contests/abc290/tasks/abc290_d)
...
### 例題
- 基本 円内格子点の数 [D - Circle Lattice Points](https://atcoder.jp/contests/abc191/tasks/abc191_d)
...
- 基本 [E - Change a Little Bit](https://atcoder.jp/contests/abc150/tasks/abc150_e)
- 基本 差がk以上の玉を選ぶ [015 - Don't be too close（★6）](https://atcoder.jp/contests/typical90/tasks/typical90_o)
- !復習価値低 [2 - マスコットの片付け (Mascots)](https://atcoder.jp/contests/joisc2013-day2/tasks/joisc2013_mascots)
- !復習価値低 [F - Range Power Sum](https://atcoder.jp/contests/abc399/tasks/abc399_f)
- 基本 [F - 1122 Subsequence 2](https://atcoder.jp/contests/abc433/tasks/abc433_f)
...
!!! where i am now for rank C (last submission 2026/5/28)
...
- !復習価値低 [G - Yet Another RGB Sequence](https://atcoder.jp/contests/abc266/tasks/abc266_g)
...
### 例題
- 基本 株の売買 [D - Road to Millionaire](https://atcoder.jp/contests/m-solutions2020/tasks/m_solutions2020_d)
...
### 例題
- 基本 グリッド経路数の総和 [F - Many Many Paths](https://atcoder.jp/contests/abc154/tasks/abc154_f)
...
- !復習価値低 [077 - Planes on a 2D Plane（★7）](https://atcoder.jp/contests/typical90/tasks/typical90_by)
...
- !復習価値低 [041 - Piles in AtCoder Farm（★7）](https://atcoder.jp/contests/typical90/tasks/typical90_ao)
...
- tolower(c)、toupper(c)で小文字、大文字変換が可能（実はc^=32の方が簡単）
...
- 出力のたびにflushするの、cout << flush;でOK

## 不等式評価
- オーバーフローがあるので、不等式評価なら割り算の形に直してから
...
## 実装テクニック（その他）
- 負整数の割り算に注意！pythonと同じ挙動となる自作関数を使う事
- 上に関連し、idを作る関数（gid/rid）は負の値があると上手くいかないので注意
...
- bitset = 1<<xなどとするとオーバーフローするので代入できない。bitset[x]=1とすると良い
...
- multisetでfor文やcountは計算量の面で危険（containsを使うなど）
...
- ビットシフトは、1LL<<62のようにLLを忘れずにつけること
- abs関数にはlong long用のllabsがあるのでそちらを使うほうが無難（GCCではabsでもOKらいしが）
- 空白も含んで入力したい場合は、string s; getline(cin,s);とする。この方式の場合、全行をgetlineで入力しないとずれるので注意
- 更にgetlineで受け取った場合、行末がおかしくなる場合あり。s.back()<=32 || s.back()>=127の場合はs.pop_back()した方が良い
- 恐らく行末にCR(=13)やNULL(=0)がついてしまうからなのだと思うが詳細不明
- 面倒なので自作関数instr()を作成したのでスニペットから使うと良い
...
- WINDOWSでMINGWのgccを使う場合、スタックオーバーフローに注意。AtCoderでは1024MBのスタックサイズが許容されているが、`ulimit -a`で調べると手元では2032KBしか確保されていなかった。ulimitでは変更が上手くいかないので、コンパイル時に`-Wl,--stack,1073741824`を指定して解決した（1073741824[Byte] = 1024MB） WSL2ならスタックを事前に確保すれば良い
