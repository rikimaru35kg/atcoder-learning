...
### 例題
- !復習価値中 丸太切り [E - Logs](https://atcoder.jp/contests/abc174/tasks/abc174_e)
...
- !復習価値高 二分探索の基本 [001 - Yokan Party（★4）](https://atcoder.jp/contests/typical90/tasks/typical90_a)
...
### 例題
- !復習価値低 平均最大化の類題 [F - Beautiful Path](https://atcoder.jp/contests/abc324/tasks/abc324_f)
- !復習価値中 砂糖水濃度最大化 [F - Sugar Water 2](https://atcoder.jp/contests/abc294/tasks/abc294_f)
...
- !復習価値低 min|x^2+y^2-D| [C - Minimize Abs 2](https://atcoder.jp/contests/abc330/tasks/abc330_c)
...
### 例題
- !復習価値中 指定区間で同色ペアを何組作れるか[G - Range Pairing Query](https://atcoder.jp/contests/abc242/tasks/abc242_g)
